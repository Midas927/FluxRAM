...
当前正式版为 **v0.4.3**，可从以下 Release 页面下载：

[国内下载（GitCode）](https://gitcode.com/Midas927/FluxRAM/releases/download/v0.4.3/FluxRAM-Portable-Windows-x64.zip) | [版本说明](https://gitcode.com/Midas927/FluxRAM/releases/v0.4.3) | [GitHub 备用下载](https://github.com/Midas927/FluxRAM/releases/tag/v0.4.3)
...
详见 [v0.4.3 更新说明](docs/releases/v0.4.3.md)。
