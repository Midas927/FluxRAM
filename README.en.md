...
[China mirror (GitCode)](https://gitcode.com/Midas927/FluxRAM/releases/download/v0.4.3/FluxRAM-Portable-Windows-x64.zip) | [Release notes](https://gitcode.com/Midas927/FluxRAM/releases/v0.4.3) | [GitHub fallback](https://github.com/Midas927/FluxRAM/releases/tag/v0.4.3)
...
- Fixed an issue that could cause Pro status to become unavailable in some situations.
- Paid users updating from a version before v0.4.3 should contact the seller once for a new Key.

See the [v0.4.3 release notes (Chinese)](docs/releases/v0.4.3.md).
